...
public class ChaosMutation implements Mutation
{
    @Override
    ...
    protected Individual mutate(Individual passedind)
    {
        ...
        {
            result.setDecisionVariable(passedind.getDecisionVariable().chaosMutate(passedind.getExplo_ra_itationFact(), passedind.getMutationNumber()));
        }
        return result;
    }
