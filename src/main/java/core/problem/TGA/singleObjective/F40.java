 ...
 */
public class F40  extends Problem<DoubleDecisionVariable> {
    //最优解取1/ci，当x取ai时
    ...
    @Override
    public F40 init(int dimension) {
        super.init(dimension);stopFitness = new double[]{111};
    ...
    public String getName() {
        return FactoryProblems.getName(40, dimension);
    }
